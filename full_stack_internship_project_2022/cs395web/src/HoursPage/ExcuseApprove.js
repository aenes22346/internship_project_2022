...
const ExcuseApprove = () => {
    ...
    const handleapprove = async (username, index) => {
        ...
        try {
            ...
            await axios.put("http://localhost:8080/admins/handleapprove/" + localStorage.getItem("User_ID"), update,
    ...
    const handledisapprove = async (username, index) => {
      ...
      try {
          ...
          await axios.put("http://localhost:8080/admins/handledisapprove/" + localStorage.getItem("User_ID"), update,
          { headers:  {'Authorization': localStorage.getItem("CurrentUser")} });
