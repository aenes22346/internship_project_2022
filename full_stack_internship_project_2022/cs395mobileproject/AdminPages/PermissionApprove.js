...
const PermissionApprove = () => {
    ...
    const handleapprove = async (username, index, permission) => {
        ...
        try {
            ...
            await axios.put("http://192.168.1.4:8080/admins/approvepermission/" + id, update,
    ...
    const handledisapprove = async (username, index, permission) => {
        ...
        try {
            ...
            await axios.put("http://192.168.1.4:8080/admins/disapprovepermission/" + id, update,
            { headers:  {'Authorization': token} });
          ...
          {arr.requests === null  || arrlength === 0 ? (
                    ...
                    You have no request waiting approval
                        ...
                        arr.map((item, index) => (
                            ...
                            PERMISSION EXCUSE : {item.permission}
                           ...
                           title="APPROVE"
                           color="#03ff46"
                           onPress={() => handleapprove(item.username, index, item.permission)}
                           />
                           ...
                           title="DISAPPROVE"
                           color="#ff0303"
                           onPress={() => handledisapprove(item.username, index, item.permission)}
                           />
